...
/* variables for pressing button 1,2,3 and 4 from the msp430.  
 Pressing button 1, Pressing button 2, Pressing button 3.
 Pressing button 4. */
int pressB1, pressB2, pressB3, pressB4;
...
switch_interrupt_handler()
{
  ...
  if(CHbutton2 !=  pressB2 && pressB2){
    pAgain2^= 1; // on button.
    
    //off buttons. 
    pAgain = 0, pAgain3 = 0, pAgain4 = 0;
  }  // end of else-if statement. 
  if(CHbutton3 !=  pressB3 && pressB3){
    pAgain3^= 1; // on button.
